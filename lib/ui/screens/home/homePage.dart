                                  ...
                                  children: <Widget>[
                                    ...
                                    Consumer<HospitalProvider>(
                                      builder: (context, data, _) {
                                        ...
                                        for (final data in data.hospitals.data) {
                                          final marker = Marker(
                                            ...
                                            child: Container(
                                              ...
                                              child: GoogleMap(
                                                ...
                                                initialCameraPosition: CameraPosition(
                                                  target: LatLng(
                                                    double.parse(data.getHospitals().data[0].lat),
                                                    double.parse(data.getHospitals().data[0].lng),
                                                  ),
                                                  zoom: 11.0,
                                                ),
                                              )
                                      ...
                                      builder: (context, data, _) {
                                        ...
                                        return Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: data.getHospitals().data.map((i) {
                                              return Builder(
                                                builder: (BuildContext context) {
                                    ...
                                    Padding(
                                      padding: EdgeInsets.only(
                                        left: 5, right: 10, top: 20, bottom: 5
                                      ),
                                      child: CustomDivider(
                                        onTap: () {
                                          print("asasa");
                                        ...
                                        return Container(
                                          ...
                                          child: Column(
                                            children: [
                                              ListTile(
                                                onTap: () {
                                                  Util().launchURL("https://www.google.com/maps/search/?api=1&query=${hospital.lat},${hospital.lng}");
                                                },
                                                leading: Icon(CupertinoIcons.location),
                                                title: Text(
                                                  data.getHospitals().data[0].name,
                                                  style: TextStyle(
                                              ...
                                              ListTile(
                                                onTap: () {
                                                  Util().launchURL("mailto:${hospital.email}");
                                                },
                                              ...
                                              ListTile(
                                                onTap: () {
                                                  Util().launchURL("tel:${hospital.phone}");
                                                },
